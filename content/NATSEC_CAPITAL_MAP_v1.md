...
The Department of War's finance office, created December 2022 and codified in Section 903 of the FY2024 National Defense Authorization Act. Unlike a procurement office, OSC uses loans and loan guarantees rather than grants and contracts, and it may finance venture and private-equity funds as well as companies. Its authority covers 31 covered technology categories, the count set by the FY2024 NDAA itself. Two different secondary sources each name a partial list that only partly overlaps the other: one cites cybersecurity, data fabric, decision science, edge computing, external communication, and mesh networks among covered categories; the FY2025 Investment Strategy's own "industry segments of particular interest" (a named subset, not the full 31) lists advanced bulk materials, advanced manufacturing, autonomous mobile robots, battery storage, biochemicals, bioenergetics, biomass, hydrogen generation and storage, microelectronics assembly/testing/packaging, microelectronics manufacturing equipment, microelectronics materials, nanomaterials and metamaterials, sensor hardware, spacecraft, and synthetic biology. Combined, at least 20 distinct category names have surfaced across these two lists, but the full, single, authoritative 31-item list has still not been pulled directly from the statute or OSC's own Investment Strategy PDF; both media.defense.gov and cto.mil are blocked to direct fetch from this environment, which is why this gap has persisted across three revisions now [UNVERIFIED]. A separate 34-count appears in one CRS product describing the pilot program rather than the statutory authority; the two numbers likely describe overlapping but not identical scopes, not a single reconciled figure.
...
- Strategic Breakthrough Award: new as of the 13 April 2026 Small Business Innovation and Economic Security Act reauthorization, a Phase II funding vehicle running up to $30M with a required 1:1 private match, available to agencies whose annual required SBIR expenditure tops $100M. This is the same award type that turns out to be the source of the "$30M rapid-funding BAA" language documented separately under Navy and ONR's SBIR/STTR entry below; it is a government-wide SBIR feature rather than a Navy-only program [UNVERIFIED, exact eligibility mechanics and how a company applies for it versus STRATFI, not confirmed at this revision].
...
The Department of the Navy's innovation-facilitation office, paired with the Office of Naval Research to run a nationwide network of regional Tech Bridges, a franchise model connecting warfare centers, academia, and industry for technology research, evaluation, and commercialization. The network now spans 18 Tech Bridges. Sites confirmed by name across two revisions of research: Capital (National Capital Region), Central Coast (Monterey, CA), Central Florida (Orlando), Gulf Coast (Panama City, FL), Hawaii (Honolulu), Inland Empire (Norco, CA), Mid-Atlantic/Hampton Roads (Norfolk, VA), Northeast (Newport, RI), Pacific Northwest, Southern Maryland/Patuxent River, Ventura, and Eastern North Carolina, roughly a dozen of the 18. The network also now extends overseas: London is a confirmed Tech Bridge site, described as the network's second overseas location, meaning at least one more overseas site exists beyond it [UNVERIFIED, the remaining domestic sites and the identity of the first overseas location are not confirmed at this revision; confirm the complete 18-site roster at navalx.nre.navy.mil before citing it]. NavalX itself does not write checks. Cumulative figures cited by ONR: $45 million in Tech Bridge projects, more than $2 million in prize challenges to non-traditional industry partners, and $37.5 million in Tech-Bridge-linked SBIR for maintenance and sustainment [CUMULATIVE — REFRESH]. The money moves through ONR, a warfare center, or the SBIR program, not through NavalX directly.
...
National Energy Dominance Council. Established by executive order on 14 February 2025, sitting inside the Executive Office of the President rather than at DoE or DoW. The Secretary of the Interior chairs it; the Secretary of Energy vice-chairs it. Membership runs to at least 19 officials: 17 heads of specified executive departments and agencies plus presidential assistants. Named members now confirmed include the Secretaries of State, Treasury, Defense, Agriculture, Commerce, and Transportation, the EPA Administrator, the Attorney General, and the President's Assistants for Domestic Policy, Economic Policy, and National Security Affairs, with the president holding authority to designate further members [UNVERIFIED, the handful of remaining named seats beyond this list, and whether any designations have changed since the council's February 2025 founding, not confirmed at this revision]. Its mandate is broader than critical minerals or defense: permitting, production, generation, distribution, regulation, and transportation across all forms of US energy, feeding into a National Energy Dominance Strategy meant to cut red tape and pull in private investment. It is the interagency body coordinating critical-minerals and energy action across DoE, the Department of War, Commerce, Interior, and EXIM specifically.
...
- OSC's full 31-category list is still not obtained from a primary source. Two partial secondary lists have now surfaced across two revisions, together naming at least 20 distinct categories, but they only partly overlap, and the definitive 31-item list has not been pulled from the statute or OSC's own Investment Strategy directly; both media.defense.gov and cto.mil are blocked to direct fetch from this environment, which is the practical reason this gap has persisted. The competing 34 figure most likely describes the pilot program specifically rather than the full statutory authority, a different scope rather than a contradiction, but that reading itself is unconfirmed.
...
- DHS SVIP's award ceiling is confirmed at up to $2M over 24 months, but the current per-phase breakdown within that structure is not confirmed against dhs.gov directly.
...
- RIF-RISE's roughly 5% hit rate comes from a secondary source, not USD(A&S) reporting directly.

**Service on-ramps and allied doors**
- NavalX's Tech Bridge count is confirmed at 18 sites; roughly a dozen are now named, including a London site described as the network's second overseas location (meaning a first overseas site exists but hasn't been identified). The remaining domestic sites and that first overseas location are still not confirmed; check navalx.nre.navy.mil for the complete roster.
- The "Navy $30M BAA" language is resolved: it refers to the new Strategic Breakthrough Award, a government-wide SBIR Phase II vehicle (up to $30M, 1:1 match) created by the April 2026 SBIR/STTR reauthorization, available to any DoD component whose annual required SBIR spend tops $100M, not a Navy-specific program. Its exact application mechanics relative to STRATFI are still not confirmed.
- ARPA-E: the live 2026 solicitation (IGNIITE, capped at $500K, concept papers due 29 May 2026) is confirmed, but whether a full OPEN-style solicitation follows later in 2026 or in 2027 is not.
- Commerce CHIPS: the startup-focused National Semiconductor Technology Center investment fund's own dollar carve-out, separate from the NSTC's $5 billion broader R&D mission, is still not isolated as its own figure.
...
- SpaceWERX's Phase II cohort model (named cohorts include TacRS, AltPNT, and Sustained Space Maneuver) is newly documented; current award sizes and company counts within each cohort are not confirmed.

**Coordination bodies (section 5)**
- National Security Capital Forum: meeting cadence and concrete outputs to date are still not confirmed. A separately named "National Security Capital Summit," run out of Air Force CyberWorx and drawing 40-plus investment groups, may or may not be how the statutory Forum actually convenes; that link is not confirmed.
- National Energy Dominance Council: most named cabinet-level seats are now confirmed (State, Treasury, Defense, Agriculture, Commerce, Transportation, EPA, Attorney General, plus three named presidential assistants), but the handful of remaining seats among its 19-plus members, and whether any designations have changed since February 2025, are not.
- Minerals Security Partnership Finance Network: the Dubbo rare-earths deal has grown and firmed up somewhat, now a non-binding, conditional EXIM Letter of Interest for up to $923M (previously cited as a $600M potential package), contingent on due diligence and a pre-feasibility study targeting Q1 2026. Whether it has since converted to a binding commitment is not confirmed.
...
A $15M fund launched in 2026 by Innovate Alabama, the state's economic-development nonprofit, split $10M for direct investment in Alabama startups and $5M as LP capital into venture funds that commit to investing in the state; checks run $100K to $250K, bridging pre-seed to Series A, and require a 1-to-1 private match. Not defense-gated, but Alabama's defense-industrial base runs directly through Innovate Alabama's broader toolkit: its separate LendAL credit program helped MAD Security, a cybersecurity firm serving defense contractors, finance an expansion, and its SBIR/STTR supplemental-grant track has backed Zeus Research and Technology, a company that trades on its proximity to Redstone Arsenal [UNVERIFIED, whether either company specifically drew on the Capital Access Fund itself, versus Innovate Alabama's other credit and grant programs, not confirmed at this revision]. The clearest state-level pre-seed/seed door with an actual defense-industrial-base track record found in this round of research.
...
Missouri's state-sponsored venture capital program, funded through a $95M SSBCI allocation and run by the Missouri Technology Corporation (MTC); to date it has deployed more than $30M to over 100 companies, including nearly $13M in direct equity or convertible-debt investments across 34 firms. Unlike most peer-state programs in this section, the IDEA Fund's own solicitation language names "applied engineering, defense and homeland security" as one of the categories it actively encourages, alongside biomedical science and plant sciences [UNVERIFIED, specific defense-sector portfolio company names not confirmed at this revision]. One flag worth carrying forward: Missouri lawmakers voted to zero out MTC's state appropriation in 2025, and while the IDEA Fund itself is reported to continue on its existing SSBCI capital, its future state-level funding is politically unsettled [UNVERIFIED, current legislative status not confirmed at this revision].
